...
export interface ApiContactLogContactLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    channelUrl: Schema.Attribute.String;
    contactType: Schema.Attribute.Enumeration<['Call', 'WhatsApp']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contactsPurchased: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    paymentGatewayId: Schema.Attribute.String;
...
export interface ApiRatingRating extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    responsivenessVote: Schema.Attribute.Enumeration<
      ['Like', 'Dislike', 'None']
    >;
    reviewText: Schema.Attribute.RichText;
